...
public class QuestionActivity extends Activity {
	...
	private OnClickListener finishListener = new OnClickListener() {
		public void onClick(View v) {
			...
			alertDialog.setMessage(id + " your score is "  + (score) +" out of " + (QuizFunActivity.getQuesList().length()));
	...
	private void setScoreTitle() {
		this.setTitle("Limkokwing Quiz     " + (quesIndex+1)+ "/" + QuizFunActivity.getQuesList().length());
	}
	
	private void showIdDialog(){
		AlertDialog.Builder dialog = new AlertDialog.Builder(this);
		dialog.setTitle("Insert Id");
		...
		dialog.setPositiveButton("Play", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				EditText ed = (EditText) view.findViewById(R.id.IDText);
